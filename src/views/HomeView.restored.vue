...
try {
  ...
  console.warn('Failed to initialize useVerseOfTheDay:', error)
  verseOfDayData = {
...
try {
  ...
  console.warn('Failed to initialize useReadingStreaks:', error)
  readingStreaksData = {
    currentStreak: ref(0),
    longestStreak: ref(0),
    totalDaysRead: ref(0),
...
try {
  ...
  console.warn('Failed to initialize useAchievements:', error)
  achievementsData = {
    achievements: ref([]),
    recentUnlocks: ref([]),
    totalProgress: ref(0),
...
try {
  ...
  console.warn('Failed to initialize useMemorization:', error)
  memorizationData = {
    stats: ref(null),
    cardsDue: ref([]),
...
try {
  ...
  console.warn('Failed to initialize useMoodTracking:', error)
  moodTrackingData = {
    recentMoods: ref([]),
